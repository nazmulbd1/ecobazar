...
const Registration = () => {
  ...
  return (
    <div className='w-[520px] font-pop bg-white p-6 shadow-md my-10 mx-auto rounded-md'>
      ...
      <input onChange={handleChange} name='password' type="password" placeholder='Password' className='w-full border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 my-4 rounded-md text-[16px]' />
      <input onChange={handleChange} name='confirmPassword' type="password" placeholder='Confirm Password' className='w-full border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md text-[16px]' />
      <div className='flex items-center my-4 text-[#666666]'>
        
        <label className='font-pop text-sm'><input onChange={handleChange} name='terms' type="checkbox" className='mr-2' /> Accept all Terms and Conditions.</label>
      </div>
