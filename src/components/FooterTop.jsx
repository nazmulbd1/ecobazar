            ...
            <div className='sm:flex justify-between items-center'>
                ...
                <div className='sm:flex'>
                    <div className="relative">
                        <input className="border border-[#E6E6E6] w-full sm:w-100 py-3 px-11 placeholder:text-[#808080] placeholder:font-pop placeholder:text-sm rounded-l-full rounded-r-full my-5 sm:my-0" type="text" placeholder="Search"/>
                        <LuSearch className="absolute top-5 sm:top-0 translate-y-1/2 left-4 text-2xl"/>
                        <button className="font-pop font-semibold text-sm bg-primary text-white px-10 py-4 sm:ml-[-40px] relative sm:top-[-2px] my-2 sm:my-0 rounded-full">
                        Search
                        </button>
                    </div>
