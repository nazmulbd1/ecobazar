            ...
            >
              {type === "category" ? (
                <img
                  src={Product1}
                  alt={item.name}
                  className="w-full h-[120px] object-contain pb-6"
                />
              ) : (
                <img
                  src={item.thumbnail}
                  alt={item.name}
                  className="w-full h-[200px] object-contain pb-6"
                />
              )}

              <div
                className={`flex items-center justify-between group ${type === "category" ? "flex-col text-center" : " "}`}
              >
                <div
                  className={
                    type === "category" ? "flex flex-col items-center" : " "
                  }
                >
              ...
              {type == "hotdeal" && (
                <div
                  className={`bg-white border w-[202%] h-[202%] z-40 absolute m-2 top-[-9px] left-[-9px] hidden group-hover:flex flex-col items-center justify-center gap-2 duration-200`}
                >
                  <img
                    src={item.thumbnail}
                    alt={item.title}
                  ...
                  <div className="flex gap-4 pb-7.5 items-center">
                    ...
                    <button className="bg-primary text-white text-[16px] font-semibold px-40 py-3 rounded-3xl">
                      Add to Cart
                    </button>
                  ...
                  <p className="text-[18px] text-[#2C742F] font-pop font-medium">
                    {item.title}
                  </p>
                  <p className="text-[24px] text-[#1A1A1A] font-medium">
                    {"$" + item.price}
                  </p>
                    ...
                    <div className="flex items-center gap-2 text-black px-8 pb-3 pt-1.5 rounded-md">
                      <div className="flex text-center gap-2">
                        <div>
                          ...
                          <p className="pt-1 text-[10px] text-gray-400 uppercase tracking-widest">
                            Days
                          </p>
                        </div>
