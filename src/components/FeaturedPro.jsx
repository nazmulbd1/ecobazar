        ...
        <div className="pt-15">
          ...
          <div>
            <div className="sm:flex justify-between items-center font-pop py-4 mb-4 mt-10 ">
              ...
              <Link
                to={link}
                className="flex gap-2 text-[14px] sm:text-[16px] text-primary"
              >
                View All
                <MoveRight />{" "}
              </Link>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 pb-15">
              {allData.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="p-3 bg-gray-200 rounded-[50%] group-hover:text-white group-hover:bg-primary">
                      <Handbag size={20} />{" "}
                    </div>
                  </div>
                </div>
